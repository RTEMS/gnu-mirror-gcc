...
void _M2_mcReserved_init (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
}

void _M2_mcReserved_finish (__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
}
