...
int a1 = -1 << 0;		/* { dg-warning "initializer element is not constant" } */
int a2 = -1 << 0 | 0;		/* { dg-warning "initializer element is not constant" } */
int a3 = -1 << 0 & 1;		/* { dg-warning "initializer element is not constant" } */
int a4 = -1 << 2 ^ 1;		/* { dg-warning "initializer element is not constant" } */
int a5 = 4 & -1 << 2;		/* { dg-warning "initializer element is not constant" } */
int a6 = (-1 << 2) ^ (1 >> 1);	/* { dg-warning "initializer element is not constant" } */
int a7 = 0 || (-1 << 1);	/* { dg-warning "initializer element is not constant" } */
int a8 = 0 ? 2 : (-1 << 1);	/* { dg-warning "initializer element is not constant" } */
int a9 = 1 && -1 << 0;		/* { dg-warning "initializer element is not constant" } */
int a10 = !(-1 << 0);		/* { dg-warning "initializer element is not constant" } */
