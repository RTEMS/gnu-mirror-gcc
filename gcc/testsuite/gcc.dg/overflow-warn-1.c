...
/* { dg-warning "initialization of 'void \\*' from 'int' makes pointer from integer without a cast" "null" { target { ! aarch64_capability_any } } .-1 } */
/* { dg-error "initializing capability 'void \\*' with an expression of incompatible type 'int'" "null" { target { aarch64_capability_any } } .-2 } */
void *q = 0 * (1 / 0); /* { dg-warning "division by zero" } */
/* { dg-error "initializer element is not constant" "constant" { target { ! aarch64_capability_any } } .-1 } */
/* { dg-warning "initialization of 'void \\*' from 'int' makes pointer from integer without a cast" "null" { target { ! aarch64_capability_any } } .-2 } */
