...
/* { dg-final { scan-assembler-times {\mxvmadd\M}   1 } } */
/* { dg-final { scan-assembler-times {\mxvmsub\M}   1 } } */
...
/* { dg-final { scan-assembler-times {\mxvnmadd\M}  1 } } */
/* { dg-final { scan-assembler-times {\mxvnmsub\M}  1 } } */
