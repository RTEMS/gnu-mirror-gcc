...
/* { dg-final { scan-assembler-times {\mfcfids|xscvsxdsp\M}  3 } } */
/* { dg-final { scan-assembler-times {\mfcfidus|xscvuxdsp\M} 1 } } */
/* { dg-final { scan-assembler-times {\mfcfid|xscvsxddp\M}   3 } } */
/* { dg-final { scan-assembler-times {\mfcfidu|xscvuxddp\M}  1 } } */
