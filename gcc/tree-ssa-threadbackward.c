...
public:
  ...
  ~back_threader_registry ();
  void register_path (const vec<basic_block> &, edge taken);
...
{
public:
  back_threader_profitability (bool speed_p, int max_paths)
    : m_speed_p (speed_p), m_max_allowable_paths (max_paths) { }
...
public:
  thread_jumps (bool speed_p = true)
    : m_profit (speed_p, param_max_fsm_thread_paths)
  { }
