...
(define_mode_iterator FP [
  (SF "TARGET_SF_FPR")
  (DF "TARGET_DF_FPR")
  (TF "TARGET_128BIT_FPR")
  (IF "TARGET_128BIT_FPR")
  (KF "TARGET_KF_IEEE128")
  (DD "TARGET_DFP")
  (TD "TARGET_DFP")])
...
(define_mode_iterator FMA_F [
  ...
  (KF "TARGET_KF_IEEE128_HW")
  (TF "TARGET_TF_IEEE128_HW")
  ])
...
(define_insn_and_split "floatsi<mode>2_lfiwax_mem"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Fv>")
   ...
   (clobber (match_scratch:DI 2 "=wi"))]
  "TARGET_DF_FPR && TARGET_LFIWAX && <SI_CONVERT_FP>"
  "#"
  ""
  [(pc)]
{
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Fv>")
   ...
   (clobber (match_scratch:DI 2 "=wi"))]
  "TARGET_DF_FPR && TARGET_LFIWZX && <SI_CONVERT_FP>"
  "#"
  ""
  [(pc)]
{
...
(define_insn_and_split "fix_trunc<mode>si2_internal"
  ...
  "TARGET_DF_FPR && !TARGET_P8_VECTOR"
  "#"
  ""
  [(pc)]
{
...
(define_insn_and_split "floatdisf2_internal1"
  ...
  "TARGET_FCFID && TARGET_SF_FPR && !TARGET_FCFIDS"
  "#"
  "&& reload_completed"
  [(set (match_dup 2)
...
(define_expand "floatdisf2_internal2"
  ...
  "TARGET_SF_FPR_64BIT && !TARGET_FCFIDS"
{
  operands[3] = gen_reg_rtx (DImode);
...
(define_expand "floatunsdisf2"
  ...
  "TARGET_SF_FPR && TARGET_DOUBLE_FLOAT && TARGET_FCFIDUS"
  "")
...
(define_expand "extendsf<mode>2w"
  [(set (match_operand:FLOAT128 0 "gpc_reg_operand")
...
(define_insn_and_split "trunc<mode>sf2_fprs"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
   ...
   (clobber (match_scratch:DF 2 "=d"))]
  "TARGET_SF_FPR && TARGET_LONG_DOUBLE_128 && FLOAT128_IBM_P (<MODE>mode)"
  "#"
  "&& reload_completed"
  [(set (match_dup 2)
  ...
  "TARGET_128BIT_FPR"
{
  ...
  if (TARGET_<MODE>_IEEE128_HW)
    ;
  else if (TARGET_<MODE>_IEEE128_SW)
    {
...
(define_insn "fix_trunc_helper<mode>"
  ...
  "TARGET_DF_FPR && FLOAT128_IBM_P (<MODE>mode)"
  "mffs %2\n\tmtfsb1 31\n\tmtfsb0 30\n\tfadd %0,%1,%L1\n\tmtfsf 1,%2"
  [(set_attr "type" "fp")
   (set_attr "length" "20")])
...
(define_expand "abs<mode>2_internal"
  ...
  "TARGET_DF_FPR && TARGET_LONG_DOUBLE_128"
{
  const int hi_word = LONG_DOUBLE_LARGE_FIRST ? 0 : GET_MODE_SIZE (DFmode);
  const int lo_word = LONG_DOUBLE_LARGE_FIRST ? GET_MODE_SIZE (DFmode) : 0;
  operands[3] = gen_reg_rtx (DFmode);
