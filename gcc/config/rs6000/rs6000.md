...
;; Iterator for modes that support large addresses.  We split the patterns into
;; int and fp, so that int operations prefer the GPRs and the fp operations
;; prefer the floating point/vector registers.
(define_mode_iterator LARGE	 [DI SF DF])
(define_mode_iterator LARGE_INT	 [DI])
(define_mode_iterator LARGE_FP	 [SF DF])

;; Attribute for the large address register constraint for GPRs, FPRs, and
;; Altivec registers.
(define_mode_attr	LARGE_GPR_REG	[(DI	"b")
					 (SF	"b")
					 (DF	"b")])

(define_mode_attr	LARGE_FPR_REG	[(DI	"d")
					 (SF	"d")
					 (DF	"d")])

(define_mode_attr	LARGE_VMX_REG	[(DI	"wb")
					 (SF	"wb")
					 (DF	"wb")])

;; Attribute for the large address memory constraint for GPRs, FPRs, and
;; Altivec registers.
(define_mode_attr	LARGE_GPR_MEM	[(DI	"wC")
					 (SF	"wC")
					 (DF	"wC")])

(define_mode_attr	LARGE_FPR_MEM	[(DI	"wC")
					 (SF	"wC")
					 (DF	"wC")])

(define_mode_attr	LARGE_VMX_MEM	[(DI	"wC")
					 (SF	"wC")
					 (DF	"wC")])

;; Attribute for the load instruction for GPRs, FPRs, and Altivec registers.
(define_mode_attr	LARGE_GPR_LOAD	[(DI	"ld %0,%m1(%0)")
					 (SF	"lwz %0,%m1(%0)")
					 (DF	"ld %0,%m1(%0)")])

(define_mode_attr	LARGE_FPR_LOAD	[(DI	"lfd %0,%m1(%2)")
					 (SF	"lfs %0,%m1(%2)")
					 (DF	"lfd %0,%m1(%2)")])

(define_mode_attr	LARGE_VMX_LOAD	[(DI	"lxsd %0,%m1(%2)")
					 (SF	"lxssp %0,%m1(%2)")
					 (DF	"lxsd %0,%m1(%2)")])

;; Attribute for the store instruction for GPRs, FPRs, and Altivec registers.
(define_mode_attr	LARGE_GPR_STORE	[(DI	"std %1,%m0(%2)")
					 (SF	"stw %1,%m0(%2)")
					 (DF	"std %1,%m0(%2)")])

(define_mode_attr	LARGE_FPR_STORE	[(DI	"stfd %1,%m0(%2)")
					 (SF	"stfs %1,%m0(%2)")
					 (DF	"stfd %1,%m0(%2)")])

(define_mode_attr	LARGE_VMX_STORE	[(DI	"stxsd %1,%m0(%2)")
					 (SF	"stxssp %1,%m0(%2)")
					 (DF	"stxsd %1,%m0(%2)")])


;; Large address splitters.  The splitters must occur before the normal move
;; insns.

(define_split
  [(set (match_operand:LARGE 0 "gpc_reg_operand")
	(match_operand:LARGE 1 "large_mem_operand"))]
  "TARGET_LARGE_ADDRESS && TARGET_POWERPC64 && can_create_pseudo_p ()"
  [(parallel [(set (match_dup 0)
		   (unspec:LARGE [(match_dup 3)] UNSPEC_LARGE_ADDRESS))
...
(define_split
  [(set (match_operand:LARGE 0 "large_mem_operand")
	(match_operand:LARGE 1 "gpc_reg_operand"))]
  "TARGET_LARGE_ADDRESS && TARGET_POWERPC64 && can_create_pseudo_p ()"
  [(parallel [(set (match_dup 0)
		   (unspec:LARGE [(match_dup 3)] UNSPEC_LARGE_ADDRESS))
	      (clobber (match_scratch:DI 2))])]
...
(define_insn "*large_mov<mode>_load"
  [(set (match_operand:LARGE_INT 0 "gpc_reg_operand"
			"=<LARGE_GPR_REG>, ?<LARGE_FPR_REG>, ?<LARGE_VMX_REG>")

	(unspec:LARGE_INT [(match_operand:LARGE_INT 1 "large_mem_operand"
			 "<LARGE_GPR_MEM>, <LARGE_FPR_MEM>,  <LARGE_VMX_MEM>")]
		   UNSPEC_LARGE_ADDRESS))
   (clobber (match_scratch:DI 2 "=X,b,b"))]

  "TARGET_LARGE_ADDRESS && TARGET_POWERPC64"
  "@
   addis %0,%M1\;<LARGE_GPR_LOAD>
   addis %2,%M1\;<LARGE_FPR_LOAD>
   addis %2,%M1\;<LARGE_VMX_LOAD>"
  [(set_attr "type" "load,fpload,fpload")
   (set_attr "length" "8")])

(define_insn "*large_mov<mode>_load"
  [(set (match_operand:LARGE_FP 0 "gpc_reg_operand"
			"=<LARGE_FPR_REG>, <LARGE_VMX_REG>, ?<LARGE_GPR_REG>")

	(unspec:LARGE_FP [(match_operand:LARGE_FP 1 "large_mem_operand"
			 "<LARGE_FPR_MEM>, <LARGE_VMX_MEM>, <LARGE_GPR_MEM>")]
		   UNSPEC_LARGE_ADDRESS))
...
(define_insn "*large_mov<mode>_store"
  [(set (match_operand:LARGE_INT 0 "large_mem_operand"
			"=<LARGE_GPR_MEM>, <LARGE_FPR_MEM>, <LARGE_VMX_MEM>")

	(unspec:LARGE_INT [(match_operand:LARGE_INT 1 "gpc_reg_operand"
			 "<LARGE_GPR_REG>, <LARGE_FPR_REG>, <LARGE_VMX_REG>")]
		   UNSPEC_LARGE_ADDRESS))
  ...
  "TARGET_LARGE_ADDRESS && TARGET_POWERPC64"
  "@
   addis %2,%M0\;<LARGE_GPR_STORE>
   addis %2,%M0\;<LARGE_FPR_STORE>
   addis %2,%M0\;<LARGE_VMX_STORE>"
  [(set_attr "type" "store,fpstore,fpstore")
   (set_attr "length" "8")])

(define_insn "*large_mov<mode>_store"
  [(set (match_operand:LARGE_FP 0 "large_mem_operand"
			"=<LARGE_FPR_MEM>, <LARGE_VMX_MEM>, ?<LARGE_GPR_MEM>")

	(unspec:LARGE_FP [(match_operand:LARGE_FP 1 "gpc_reg_operand"
			 "<LARGE_FPR_REG>, <LARGE_VMX_REG>, <LARGE_GPR_REG>")]
		   UNSPEC_LARGE_ADDRESS))
...
(define_insn "*bswap<mode>2_extenddi"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r")
	(zero_extend:DI
	 (bswap:HSI (match_operand:HSI 1 "memory_operand_not_large" "Z"))))]
  "TARGET_POWERPC64"
  "l<wd>brx %0,%y1"
  [(set_attr "length" "4")
   (set_attr "type" "load")])
...
(define_insn "*bswaphi2_extendsi"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r")
	(zero_extend:SI
	 (bswap:HI (match_operand:HI 1 "memory_operand_not_large" "Z"))))]
  ""
  "lhbrx %0,%y1"
  [(set_attr "length" "4")
   (set_attr "type" "load")])
...
(define_insn "bswap<mode>2_store"
  [(set (match_operand:HSI 0 "memory_operand_not_large" "=Z")
...
(define_insn "bswapdi2_load"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r")
	(bswap:DI (match_operand:DI 1 "memory_operand_not_large" "Z")))]
  "TARGET_POWERPC64 && TARGET_LDBRX"
  "ldbrx %0,%y1"
  [(set_attr "type" "load")])

(define_insn "bswapdi2_store"
  [(set (match_operand:DI 0 "memory_operand_not_large" "=Z")
...
(define_insn_and_split "ashdi3_extswsli_dot"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,?y,?x,??y")
	(compare:CC
	 (ashift:DI
	  (sign_extend:DI (match_operand:SI 1 "reg_or_mem_operand" "r,r,wN,wN"))
  ...
  "&& reload_completed
   && (cc_reg_not_cr0_operand (operands[3], CCmode)
       || memory_operand_not_large (operands[1], SImode))"
  [(pc)]
{
  rtx dest = operands[0];
  rtx src = operands[1];
...
(define_insn_and_split "*signbit<mode>2_dm_mem"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=b")
	(unspec:DI [(match_operand:SIGNBIT 1 "memory_operand_not_large" "wN")]
		   UNSPEC_SIGNBIT))]
  "TARGET_POWERPC64 && TARGET_DIRECT_MOVE"
  "#"
  "&& 1"
...
(define_insn_and_split "*fix<uns>_trunc<SFDF:mode><QHSI:mode>2_mem"
  [(set (match_operand:QHSI 0 "memory_operand_not_large" "=Z")
...
(define_insn "stfiwx"
  [(set (match_operand:SI 0 "memory_operand_not_large" "=Z,Z")
...
(define_insn_and_split "*floatdidf2_mem"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d,ws")
	(float:DF (match_operand:DI 1 "memory_operand_not_large" "wN,Z")))
...
(define_insn_and_split "*floatunsdidf2_mem"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d,ws")
	(unsigned_float:DF
	 (match_operand:DI 1 "memory_operand_not_large" "wN,Z")))
   (clobber (match_scratch:DI 2 "=d,wi"))]
...
(define_insn_and_split "*floatdisf2_mem"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy,wy")
	(float:SF
	 (match_operand:DI 1 "memory_operand_not_large" "wN,wN,Z")))
...
(define_split
  [(set (match_operand:SI 0 "gpc_reg_operand")
	(unspec:SI [(match_operand:SI 1 "got_no_const_operand")
		    (match_operand:SI 2 "memory_operand_not_large")]
		   UNSPEC_MOVSI_GOT))]
  "DEFAULT_ABI == ABI_V4
    && flag_pic == 1
    && reload_completed"
...
(define_insn "*movsi_internal1"
  ...
  "!TARGET_SINGLE_FPU && move_valid_p (operands[0], operands[1], SImode)"
  "@
   mr %0,%1
   la %0,%a1
   lwz%U1%X1 %0,%1
...
(define_insn "*movsi_internal1_single"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=r,r,r,wN,r,r,r,r,*c*l,*h,*h,wN,*f")
        (match_operand:SI 1 "input_operand" "r,U,wN,r,I,L,n,*h,r,r,0,f,wN"))]
  "TARGET_SINGLE_FPU && move_valid_p (operands[0], operands[1], SImode)"
  "@
   mr %0,%1
   la %0,%a1
...
(define_insn "*movsi_from_df"
  [(set (match_operand:SI 0 "nonimmediate_operand"         "=wa,wN,wY,Z")
...
(define_insn "*mov<mode>_internal"
  ...
  "move_valid_p (operands[0], operands[1], <MODE>mode)"
  "@
   mr %0,%1
   l<wd>z%U1%X1 %0,%1
   lxsi<wd>zx %x0,%y1
...
(define_insn "*movcc_internal1"
  [(set (match_operand:CC 0 "nonimmediate_operand"
			    "=y,x,?y,y,r,r,r,r,r,*c*l,r, wN")
	(match_operand:CC 1 "general_operand"
			    " y,r, r,O,x,y,r,I,h,   r,wN,r"))]
  ...
  [(set (match_operand:SF 0 "nonimmediate_operand"
	...
	(match_operand:SF 1 "input_operand"
	 "wN,        wN,        wY,         Z,         f,         wb,
	  wu,        r,         j,          j,         f,         ww,
	  r,         r,         *h,         0"))]
  "move_valid_p (operands[0], operands[1], SFmode)
   && TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT
...
(define_insn "movsd_hardfloat"
  [(set (match_operand:SD 0 "nonimmediate_operand"
	...
	(match_operand:SD 1 "input_operand"
	 "wN,        Z,         r,         wx,        r,         wh,
	  f,         r,         r,         *h,        0"))]
  "move_valid_p (operands[0], operands[1], SDmode)
   && TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT"
  "@
   lwz%U1%X1 %0,%1
   lfiwzx %0,%y1
...
(define_insn "*mov<mode>_softfloat"
  ...
  "TARGET_SOFT_FLOAT && move_valid_p (operands[0], operands[1], <MODE>mode)"
  "@
   mr %0,%1
   mt%0 %1
   mf%1 %0
...
(define_insn "*movdi_internal32"
  ...
  "! TARGET_POWERPC64 && move_valid_p (operands[0], operands[1], DImode)"
  "@
   #
   #
   #
...
(define_expand "save_stack_nonlocal"
  [(set (match_dup 3) (match_dup 4))
   (set (match_operand 0 "memory_operand_not_large") (match_dup 3))
...
(define_expand "restore_stack_nonlocal"
  [(set (match_dup 2) (match_operand 1 "memory_operand_not_large"))
   (set (match_dup 3) (match_dup 4))
...
(define_insn "*call_indirect_aix<mode>"
  [(call (mem:SI (match_operand:P 0 "register_operand" "c,*l"))
	 (match_operand 1 "" "g,g"))
   (use (match_operand:P 2 "memory_operand_not_large" "<ptrm>,<ptrm>"))
...
(define_insn "*call_value_indirect_aix<mode>"
  [(set (match_operand 0 "" "")
	(call (mem:SI (match_operand:P 1 "register_operand" "c,*l"))
	      (match_operand 2 "" "g,g")))
   (use (match_operand:P 3 "memory_operand_not_large" "<ptrm>,<ptrm>"))
...
(define_insn "probe_stack_<mode>"
  [(set (match_operand:P 0 "memory_operand_not_large" "=wN")
...
(define_expand "stack_protect_set"
  [(match_operand 0 "memory_operand_not_large")
   (match_operand 1 "memory_operand_not_large")]
  ""
{
...
(define_insn "stack_protect_setsi"
  [(set (match_operand:SI 0 "memory_operand_not_large" "=wN")
	(unspec:SI [(match_operand:SI 1 "memory_operand_not_large" "wN")]
		   UNSPEC_SP_SET))
...
(define_insn "stack_protect_setdi"
  [(set (match_operand:DI 0 "memory_operand_not_large" "=Y")
	(unspec:DI [(match_operand:DI 1 "memory_operand_not_large" "Y")]
		   UNSPEC_SP_SET))
...
(define_insn "stack_protect_testsi"
  [(set (match_operand:CCEQ 0 "cc_reg_operand" "=x,?y")
        (unspec:CCEQ [(match_operand:SI 1 "memory_operand_not_large" "wN,wN")
		      (match_operand:SI 2 "memory_operand_not_large" "wN,wN")]
		     UNSPEC_SP_TEST))
...
(define_insn "stack_protect_testdi"
  [(set (match_operand:CCEQ 0 "cc_reg_operand" "=x,?y")
        (unspec:CCEQ [(match_operand:DI 1 "memory_operand_not_large" "Y,Y")
		      (match_operand:DI 2 "memory_operand_not_large" "Y,Y")]
		     UNSPEC_SP_TEST))
...
(define_insn "*crsave"
  [(match_parallel 0 "crsave_operation"
		   [(set (match_operand:SI 1 "memory_operand_not_large" "=wN")
			 (match_operand:SI 2 "gpc_reg_operand" "r"))])]
  ""
  "stw %2,%1"
  [(set_attr "type" "store")])
  ...
  [(match_parallel 0 "any_parallel_operand"
		   [(clobber (reg:P LR_REGNO))
		    (use (match_operand:P 1 "symbol_ref_operand" "s"))
                    (use (reg:P 11))
		    (set (match_operand:P 2 "memory_operand_not_large" "=wN")
			 (match_operand:P 3 "gpc_reg_operand" "r"))])]
  ""
  "bl %1"
  [(set_attr "type" "branch")
...
(define_insn "*save_fpregs_<mode>_r11"
  [(match_parallel 0 "any_parallel_operand"
		   [(clobber (reg:P LR_REGNO))
		    (use (match_operand:P 1 "symbol_ref_operand" "s"))
                    (use (reg:P 11))
		    (set (match_operand:DF 2 "memory_operand_not_large" "=wN")
...
(define_insn "*lmw"
  [(match_parallel 0 "lmw_operation"
		   [(set (match_operand:SI 1 "gpc_reg_operand" "=r")
       			 (match_operand:SI 2 "memory_operand_not_large" "wN"))])]
  "TARGET_MULTIPLE"
  "lmw %1,%2"
  [(set_attr "type" "load")
   (set_attr "update" "yes")
 ...
 [(match_parallel 0 "any_parallel_operand"
		  [(clobber (reg:P LR_REGNO))
		   ...
		   (set (match_operand:P 2 "gpc_reg_operand" "=r")
			(match_operand:P 3 "memory_operand_not_large" "wN"))])]
 ""
 "bl %1"
 [(set_attr "type" "branch")
  (set_attr "length" "4")])
 ...
 [(match_parallel 0 "any_parallel_operand"
		  [(return)
		   ...
		   (set (match_operand:DF 2 "gpc_reg_operand" "=d")
			(match_operand:DF 3 "memory_operand_not_large" "wN"))])]
 ""
 "b %1"
 [(set_attr "type" "branch")
  (set_attr "length" "4")])
...
(define_insn_and_split "unpack<mode>_dm"
  [(set (match_operand:<FP128_64> 0 "nonimmediate_operand" "=d,wN,d,r,wN")
	(unspec:<FP128_64>
