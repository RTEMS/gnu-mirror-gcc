...
(define_mode_iterator SDKF_FP [SF
			       DF
...
(define_expand "s<minmax><mode>3"
  [(set (match_operand:SDKF_FP 0 "gpc_reg_operand")
	(fp_minmax:SDKF_FP (match_operand:SDKF_FP 1 "gpc_reg_operand")
			(match_operand:SDKF_FP 2 "gpc_reg_operand")))]
  "TARGET_MINMAX"
{
...
(define_insn "*s<minmax><mode>3_vsx"
  [(set (match_operand:SDKF_FP 0 "vsx_register_operand" "=<Fm>")
	(fp_minmax:SDKF_FP
	 (match_operand:SDKF_FP 1 "vsx_register_operand" "<Fm>")
	 (match_operand:SDKF_FP 2 "vsx_register_operand" "<Fm>")))]
