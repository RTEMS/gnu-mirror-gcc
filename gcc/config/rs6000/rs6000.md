...
(define_mode_iterator ALTIVEC_DFORM [(DI "TARGET_UPPER_REGS_DI")
				     (DF "TARGET_UPPER_REGS_DF")
				     (SF "TARGET_UPPER_REGS_SF")])

...
(define_peephole2
  [(match_scratch:P 0 "b")
   ...
   (set (match_operand:ALTIVEC_DFORM 3 "altivec_register_operand")
	(match_dup 1))]
  "TARGET_VSX && peep2_reg_dead_p (2, operands[1])"
  [(set (match_dup 0)
	(match_dup 4))
   (set (match_dup 3)
	(match_dup 5))]
{
  ...
  new_addr = gen_rtx_PLUS (<P:MODE>mode, add_op0, base);
