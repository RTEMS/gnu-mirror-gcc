...
;;	   XXLXOR 0    XXLORC -1   P9 const    P10 const
;;	   MTVSRWZ     MFVSRWZ
;;	   MF%1        MT%0        NOP
...
(define_insn "*movsi_internal1"
  ...
  [(set_attr "type"
	   ...
	   *,          *,          *,          *,
	   ...
	   veclogical, veclogical, vecsimple,  vecsimple,
	   mtvsr,      mfvsr,
	   *,          *,          *")
   (set_attr "length"
	  "*,          *,
...
;;		XXLOR       load 0     load -1    VSPLTI*    XXSPLITIW  #
;;		MFVSRWZ     MTVSRWZ    MF%1       MT%1       NOP
(define_insn "*mov<mode>_internal"
  ...
  [(set_attr "type"
		"*,         load,      fpload,    store,     fpstore,   *,
		 vecsimple, vecperm,   vecperm,   vecperm,   vecsimple, vecperm,
		 mfvsr,     mtvsr,     mfjmpr,    mtjmpr,    *")
   (set_attr "length"
		"*,         *,         *,         *,         *,         *,
		 *,         *,         *,         *,         12,        8,
		 *,         *,         *,         *,         *")
