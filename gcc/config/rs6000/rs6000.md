...
(define_mode_iterator FMIN2 [(SF "TARGET_P9_MINMAX")
			     (DF "TARGET_P9_MINMAX")
			     (KF "have_compare_and_set_mask (KFmode)")
			     (TF "have_compare_and_set_mask (TFmode)")])

;; Constraint to use for the minimum, maximum, and set compare mask
;; instructions.
...
(define_insn_and_split "*mov<FMIN:mode><FMIN2:mode>cc"
  [(set (match_operand:FMIN 0 "vsx_register_operand" "=<FMIN:Fm>")
	(if_then_else:FMIN
	 (match_operator:CCFP 1 "fpmask_comparison_operator"
		[(match_operand:FMIN2 2 "vsx_register_operand" "<FMIN2:Fm>")
		 (match_operand:FMIN2 3 "vsx_register_operand" "<FMIN2:Fm>")])
	 (match_operand:FMIN 4 "vsx_register_operand" "<FMIN:Fm>")
	 (match_operand:FMIN 5 "vsx_register_operand" "<FMIN:Fm>")))
   (clobber (match_scratch:V2DI 6 "=&<FMIN2:Fm>"))]
  "TARGET_P9_MINMAX"
  "#"
  "&& 1"
  [(set (match_dup 6)
...
(define_insn_and_split "*mov<FMIN:mode><FMIN2:mode>cc_invert"
  [(set (match_operand:FMIN 0 "vsx_register_operand" "=<FMIN:Fm>")
	(if_then_else:FMIN
