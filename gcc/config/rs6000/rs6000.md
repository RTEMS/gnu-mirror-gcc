...
(define_mode_iterator LADDR	 [DI])
(define_mode_iterator LADDR_I	 [DI])

;;(define_mode_iterator LADDR	 [DI SF DF])
;;(define_mode_iterator LADDR_FP [SF DF])

;; Attribute for the large address register constraint for GPRs, FPRs, and
;; Altivec registers.
(define_mode_attr LADDR_GREG	[(DI "b")
				 (SF "b")
				 (DF "b")])

(define_mode_attr LADDR_FREG	[(DI "d")
				 (SF "d")
				 (DF "d")])

(define_mode_attr LADDR_VREG	[(DI "wb")
				 (SF "wb")
				 (DF "wb")])

;; Attribute for the large address memory constraint for GPRs, FPRs, and
;; Altivec registers.
(define_mode_attr LADDR_GMEM	[(DI "wC")
				 (SF "wC")
				 (DF "wC")])

(define_mode_attr LADDR_FMEM	[(DI "wC")
				 (SF "wC")
				 (DF "wC")])

(define_mode_attr LADDR_VMEM	[(DI "wC")
				 (SF "wC")
				 (DF "wC")])

;; Attribute for the load instruction for GPRs, FPRs, and Altivec registers.
(define_mode_attr LADDR_GLOAD	[(DI "addis %0,%M1\;ld %0,%m1(%0)")
				 (SF "addis %0,%M1\;lwz %0,%m1(%0)")
				 (DF "addis %0,%M1\;ld %0,%m1(%0)")])

(define_mode_attr LADDR_FLOAD	[(DI "addis %2,%M1\;lfd %0,%m1(%2)")
				 (SF "addis %2,%M1\;lfs %0,%m1(%2)")
				 (DF "addis %2,%M1\;lfd %0,%m1(%2)")])

(define_mode_attr LADDR_VLOAD	[(DI "addis %2,%M1\;lxsd %0,%m1(%2)")
...
(define_mode_attr LADDR_GSTORE [(DI "addis %2,%M0\;std %1,%m0(%2)")
				(SF "addis %2,%M0\;stw %1,%m0(%2)")
				(DF "addis %2,%M0\;std %1,%m0(%2)")])

(define_mode_attr LADDR_FSTORE [(DI "addis %2,%M0\;stfd %1,%m0(%2)")
				(SF "addis %2,%M0\;stfs %1,%m0(%2)")
				(DF "addis %2,%M0\;stfd %1,%m0(%2)")])

(define_mode_attr LADDR_VSTORE [(DI "addis %2,%M0\;stxsd %1,%m0(%2)")
...
(define_insn_and_split "large_mov<mode>_load"
  [(set (match_operand:LADDR_I 0 "gpc_reg_operand"
		"=<LADDR_GREG>, ?<LADDR_FREG>, ?<LADDR_VREG>")
	(unspec:LADDR_I [(match_operand:LADDR_I 1 "large_mem_operand"
		 "<LADDR_GMEM>,  <LADDR_FMEM>,  <LADDR_VMEM>")
			   (const_int 0)]
			  UNSPEC_LADDRESS))
...
(define_insn_and_split "large_mov<mode>_store"
  [(set (match_operand:LADDR_I 0 "large_mem_operand"
		"=<LADDR_GMEM>, ?<LADDR_FMEM>, ?<LADDR_VMEM>")
	(unspec:LADDR_I [(match_operand:LADDR_I 1 "gpc_reg_operand"
		 "<LADDR_GREG>,  <LADDR_FREG>,  <LADDR_VREG>")
			   (const_int 1)]
			  UNSPEC_LADDRESS))
...
(define_split
  [(set (match_operand:LADDR_I 0 "large_mem_operand")
	(match_operand:LADDR_I 1 "gpc_reg_operand"))]
...
(define_insn_and_split "*floatdidf2_mem"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d,ws,ws,wb")
	(float:DF (match_operand:DI 1 "memory_operand" "wN,wN,Z,wY")))
   (clobber (match_scratch:DI 2 "=d,d,wi,wi"))]
  "TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT && TARGET_FCFID
   && !large_address_valid (XEXP (operands[1], 0), DImode)"
  "#"
  "&& reload_completed"
...
(define_insn_and_split "*floatunsdidf2_mem"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d,d,ws,wb")
	(unsigned_float:DF (match_operand:DI 1 "memory_operand" "wN,wN,Z,wY")))
   (clobber (match_scratch:DI 2 "=d,d,wi,wi"))]
...
(define_insn_and_split "*floatdisf2_mem"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy,wy,wb")
	(float:SF (match_operand:DI 1 "memory_operand" "wN,wN,Z,wY")))
   (clobber (match_scratch:DI 2 "=d,d,wi,wi"))]
  "TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT
   && TARGET_DOUBLE_FLOAT && TARGET_FCFIDS
   && !large_address_valid (XEXP (operands[1], 0), DImode)"
...
(define_insn_and_split "*floatunsdisf2_mem"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy,wy,wy")
	(unsigned_float:SF (match_operand:DI 1 "memory_operand" "wN,wN,Z,wY")))
   (clobber (match_scratch:DI 2 "=d,d,wi,wi"))]
  "TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT
   && TARGET_DOUBLE_FLOAT && TARGET_FCFIDUS
   && !large_address_valid (XEXP (operands[1], 0), DImode)"
...
;;              GPR store  Large load GPR load   GPR move   GPR li     GPR lis
...
;;              SPR<->SPR  FPR->GPR   GPR->FPR   VSX->GPR   GPR->VSX
