...
;; Constraint to use for the minimum, maximu, and set compare mask
;; instructions.
...
;; used the original min/max instructions if -ffast-math was used.
(define_mode_iterator F_MINMAX [(SF "TARGET_MINMAX")
				(DF "TARGET_MINMAX")
				(KF "HAS_FLOAT128_MINMAX (KFmode)")
				(TF "HAS_FLOAT128_MINMAX (TFmode)")])

;; Iterator to allow doing conditional moves where the comparison is one
;; floating point type and the conditional move is another.  This depends on
;; having the compare and set mask instruction so that XXSEL can be used to do
;; the conditional mvoe.
(define_mode_iterator F_MINMAX2 [(SF "TARGET_P9_MINMAX")
				 (DF "TARGET_P9_MINMAX")
				 (KF "HAS_FLOAT128_MINMAX (KFmode)")
				 (TF "HAS_FLOAT128_MINMAX (TFmode)")])
...
(define_expand "s<minmax><mode>3"
  [(set (match_operand:F_MINMAX 0 "gpc_reg_operand")
	(fp_minmax:F_MINMAX
	 (match_operand:F_MINMAX 1 "gpc_reg_operand")
	 (match_operand:F_MINMAX 2 "gpc_reg_operand")))]
  "TARGET_MINMAX"
{
...
(define_insn "*s<minmax><mode>3_vsx"
  [(set (match_operand:F_MINMAX 0 "vsx_register_operand" "=<Fm>")
	(fp_minmax:F_MINMAX
	 (match_operand:F_MINMAX 1 "vsx_register_operand" "<Fm>")
	 (match_operand:F_MINMAX 2 "vsx_register_operand" "<Fm>")))]
...
(define_expand "mov<mode>cc"
   [(set (match_operand:F_MINMAX 0 "gpc_reg_operand")
	 (if_then_else:F_MINMAX (match_operand 1 "comparison_operator")
				(match_operand:F_MINMAX 2 "gpc_reg_operand")
				(match_operand:F_MINMAX 3 "gpc_reg_operand")))]
...
(define_insn_and_split "*mov<F_MINMAX:mode><F_MINMAX2:mode>cc"
  [(set (match_operand:F_MINMAX 0 "vsx_register_operand" "=<F_MINMAX:Fm>")
	(if_then_else:F_MINMAX
	 (match_operator:CCFP 1 "fpmask_comparison_operator"
		[(match_operand:F_MINMAX2 2 "vsx_register_operand"
						"<F_MINMAX2:Fm>")
		 (match_operand:F_MINMAX2 3 "vsx_register_operand"
						"<F_MINMAX2:Fm>")])
	 (match_operand:F_MINMAX 4 "vsx_register_operand" "<F_MINMAX:Fm>")
	 (match_operand:F_MINMAX 5 "vsx_register_operand" "<F_MINMAX:Fm>")))
   (clobber (match_scratch:V2DI 6 "=&<F_MINMAX2:Fm>"))]
  ""
  "#"
  ""
  [(set (match_dup 6)
	(if_then_else:V2DI (match_dup 1)
			   ...
			   (match_dup 8)))
   (set (match_dup 0)
	(if_then_else:F_MINMAX (ne (match_dup 6)
				      (match_dup 8))
				  (match_dup 4)
				  (match_dup 5)))]
{
...
(define_insn_and_split "*mov<F_MINMAX:mode><F_MINMAX2:mode>cc_invert"
  [(set (match_operand:F_MINMAX 0 "vsx_register_operand" "=<F_MINMAX:Fm>")
	(if_then_else:F_MINMAX
...
(define_insn "*fpmask<mode>"
  [(set (match_operand:V2DI 0 "vsx_register_operand" "=wa")
	(if_then_else:V2DI
	 (match_operator:CCFP 1 "fpmask_comparison_operator"
		[(match_operand:F_MINMAX 2 "vsx_register_operand" "<Fm>")
		 (match_operand:F_MINMAX 3 "vsx_register_operand" "<Fm>")])
...
(define_insn "*xxsel<mode>"
  [(set (match_operand:F_MINMAX 0 "vsx_register_operand" "=<Fm>")
	(if_then_else:F_MINMAX (ne (match_operand:V2DI 1 "vsx_register_operand" "wa")
				   (match_operand:V2DI 2 "zero_constant" ""))
			       (match_operand:F_MINMAX 3 "vsx_register_operand" "<Fm>")
			       (match_operand:F_MINMAX 4 "vsx_register_operand" "<Fm>")))]
  "TARGET_P9_MINMAX"
  "xxsel %x0,%x4,%x3,%x1"
