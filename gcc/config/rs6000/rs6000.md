...
(define_insn_and_split "*extendsfdf2_fpr"
  ...
  "@
   #
   * return rs6000_output_move_scalar_fpr (SFmode);
   lfs%U1%X1 %0,%1
   #
   * return rs6000_output_move_scalar_vsx (SFmode);
   lxsspx %x0,%y1
   lxssp %0,%1"
...
(define_insn "*movsi_internal1"
  ...
  "@
   ...
   lis %0,%v1
   #
   * return rs6000_output_move_scalar_vsx (SImode);
   xxspltib %x0,0
   xxspltib %x0,255
   vspltisw %0,%1
   xxlxor %x0,%x0,%x0
...
(define_insn "*mov<mode>_internal"
  ...
  "@
   ...
   stxsi<wd>x %x1,%y0
   li %0,%1
   * return rs6000_output_move_scalar_vsx (<MODE>mode);
   xxspltib %x0,0
   xxspltib %x0,255
   vspltis<wd> %0,%1
   #
...
(define_insn "movsd_hardfloat"
  ...
  "@
   ...
   mtvsrwz %x0,%1
   mfvsrwz %0,%x1
   * return rs6000_output_move_scalar_fpr (SDmode);
   mr %0,%1
   mt%0 %1
   mf%1 %0
   nop"
...
(define_insn "*mov<mode>_hardfloat32"
  ...
  "@
   stfd%U0%X0 %1,%0
   lfd%U1%X1 %0,%1
   * return rs6000_output_move_scalar_fpr (<MODE>mode);
   lxsd %0,%1
   stxsd %1,%0
   lxsd%U1x %x0,%y1
   stxsd%U0x %x1,%y0
...
(define_insn_and_split "trunc<mode>df2_internal1"
  ...
  "@
   #
   * return rs6000_output_move_scalar_fpr (DFmode);"
...
(define_insn "*movdi_internal32"
  ...
  "@
   ...
   stfd%U0%X0 %1,%0
   lfd%U1%X1 %0,%1
   * return rs6000_output_move_scalar_fpr (DImode);
   #
   stxsd %1,%0
   stxsdx %x1,%y0
   lxsd %0,%1
   lxsdx %x0,%y1
   * return rs6000_output_move_scalar_vsx (DImode);
   xxspltib %x0,0
   xxspltib %x0,255
   vspltisw %0,%1
   xxlxor %x0,%x0,%x0
   ...
   #"
  [(set_attr "type"
               "store,     load,      *,         fpstore,    fpload,     veclogical,
...
(define_insn "*movdi_internal64"
  ...
  [(set_attr "type"
               "store,      load,	*,         *,         *,         *,
                fpstore,    fpload,     veclogical,fpstore,   fpstore,   fpload,
