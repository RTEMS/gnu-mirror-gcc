...
;; Alternate sqrtq function for libquadmath compatibility.  An alternate
;; function is needed because you cannot attach two built-in functions to the
;; same insn.
(define_expand "sqrt<mode>2_quadmath"
  [(set (match_operand:IEEE128 0 "altivec_register_operand" "")
	(sqrt:IEEE128
	 (match_operand:IEEE128 1 "altivec_register_operand" "")))]
  "TARGET_FLOAT128_HW && FLOAT128_IEEE_P (<MODE>mode)"
  "")
...
;; Expander to allow both __builtin_fmaf128 and __builtin_fmaq
(define_expand "fma<mode>4_quadmath"
  [(set (match_operand:IEEE128 0 "altivec_register_operand" "")
	(fma:IEEE128
	 (match_operand:IEEE128 1 "altivec_register_operand" "")
	 (match_operand:IEEE128 2 "altivec_register_operand" "")
	 (match_operand:IEEE128 3 "altivec_register_operand" "")))]
  "TARGET_FLOAT128_HW && FLOAT128_IEEE_P (<MODE>mode)"
  "")
