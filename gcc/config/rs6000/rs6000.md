...
;;	a = (x == y) ? b : c;
;;
;; This is because the XSCMPEQDP instruction clears the bottom 64-bits of the
;; register
(define_insn_and_split "*mov<FSCALAR:mode><FSCALAR2:mode>cc"
  ...
  "TARGET_P9_MINMAX
   && (!FLOAT128_IEEE_P (<FSCALAR:MODE>mode)
       || FLOAT128_IEEE_P (<FSCALAR2:MODE>mode))"
  "#"
  "&& 1"
  [(set (match_dup 6)
	(if_then_else:V2DI (match_dup 1)
			   ...
			   (match_dup 8)))
   (set (match_dup 0)
	(if_then_else:FSCALAR (ne (match_dup 6)
				  (match_dup 8))
			      (match_dup 4)
			      (match_dup 5)))]
{
...
(define_insn_and_split "*mov<FSCALAR:mode><FSCALAR2:mode>cc_invert"
  [(set (match_operand:FSCALAR 0 "vsx_register_operand" "=<FSCALAR:Fm>")
	(if_then_else:FSCALAR
