...
(define_insn "*movsi_internal1"
  ...
  "move_valid_p (operands[0], operands[1], SImode)"
  "@
   mr %0,%1
   la %0,%a1
   lwz%U1%X1 %0,%1
  ...
  [(set (match_operand:SF 0 "nonimmediate_operand"
	...
	(match_operand:SF 1 "input_operand"
	 "wN,        wN,        wY,         Z,         f,         wb,
	  wu,        r,         j,          j,         f,         ww,
	  r,         r,         *h,         0"))]
  "TARGET_HARD_FLOAT && move_valid_p (operands[0], operands[1], SFmode)"
  "@
   lwz%U1%X1 %0,%1
   lfs%U1%X1 %0,%1
   lxssp %0,%1
...
(define_insn "movsd_hardfloat"
  [(set (match_operand:SD 0 "nonimmediate_operand"
	...
	(match_operand:SD 1 "input_operand"
	 "wN,        Z,         r,         wx,        r,         wh,
	  f,         r,         r,         *h,        0"))]
  "TARGET_HARD_FLOAT && move_valid_p (operands[0], operands[1], SDmode)"
  "@
   lwz%U1%X1 %0,%1
   lfiwzx %0,%y1
   stw%U0%X0 %1,%0
