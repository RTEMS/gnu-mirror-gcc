  ...
  [(const_int 0)]
{
  ...
  rtx element = VECTOR_ELT_ORDER_BIG ? const1_rtx : const0_rtx;

  emit_insn (gen_altivec_vupkhsw (dest_v2di, src_v4si));
  emit_insn (gen_vsx_xxspltd_v2di (dest_v2di, dest_v2di, element));
  DONE;
})
  ...
  [(pc)]
{
  ...
  emit_insn (gen_fctiwz_<mode>_no_smallint (tmp, src));
  if (MEM_P (dest))
    {
  ...
  "
{
  ...
  emit_insn (gen_fctiwz_<mode>_no_smallint (operands[2], operands[1]));
  emit_move_insn (operands[3], operands[2]);
  ...
  [(pc)]
{
  ...
  emit_insn (gen_fctiwuz_<mode>_no_smallint (tmp, src));
  if (MEM_P (dest))
    {
      dest = rs6000_address_for_fpconvert (dest);
      emit_insn (gen_stfiwx (dest, tmp));
...
(define_insn "fctiwz_<mode>_no_smallint"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d,wi")
	(unspec:DI [(fix:SI
		     (match_operand:SFDF 1 "gpc_reg_operand" "<Ff>,<Fv>"))]
		   UNSPEC_FCTIWZ))]
...
(define_insn "fctiwuz_<mode>_no_smallint"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d,wi")
  ...
  [(pc)]
{
  ...
  emit_insn (gen_fctiwz_<mode>_no_smallint (tmp1, src));
  ...
  [(pc)]
{
  ...
  emit_insn (gen_fctiwuz_<mode>_no_smallint (tmp1, src));
  emit_insn (gen_stfiwx (stack, tmp1));
  ...
  [(pc)]
{
  ...
  emit_insn (gen_fctiwz_df_no_smallint (operands[4], operands[2]));
  emit_move_insn (operands[5], operands[4]);
  emit_move_insn (operands[0], lowword);
  DONE;
})
