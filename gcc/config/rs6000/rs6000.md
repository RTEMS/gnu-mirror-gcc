...
;; Dual iterators for floating point conditional move.  We use two parallel
;; iterators, so that you can compare one floating point mode (such as SF) and
;; do the conditional move on another mode (such as DF).
(define_mode_iterator FCMV1 [SF
			     DF
			     (KF "FLOAT128_IEEE_MINMAX_P (KFmode)")
			     (TF "FLOAT128_IEEE_MINMAX_P (KFmode)")])

(define_mode_iterator FCMV2 [SF
			     DF
			     (KF "FLOAT128_IEEE_MINMAX_P (KFmode)")
			     (TF "FLOAT128_IEEE_MINMAX_P (KFmode)")])

;; Constraints to use for min/max and conditional move operations.
...
(define_insn_and_split "*mov<FCMV1:mode><FCMV2:mode>cc"
  [(set (match_operand:FCMV1 0 "vsx_register_operand" "=<FCMV1:Fm>")
	(if_then_else:FCMV1
	 (match_operator:CCFP 1 "fpmask_comparison_operator"
		[(match_operand:FCMV2 2 "vsx_register_operand" "<FCMV2:Fm>")
		 (match_operand:FCMV2 3 "vsx_register_operand" "<FCMV2:Fm>")])
	 (match_operand:FCMV1 4 "vsx_register_operand" "<FCMV1:Fm>")
	 (match_operand:FCMV1 5 "vsx_register_operand" "<FCMV1:Fm>")))
   (clobber (match_scratch:V2DI 6 "=&<FCMV2:Fm>"))]
  "TARGET_P9_MINMAX"
  "#"
  ""
  [(set (match_dup 6)
	(if_then_else:V2DI (match_dup 1)
			   ...
			   (match_dup 8)))
   (set (match_dup 0)
	(if_then_else:FCMV1 (ne (match_dup 6)
				(match_dup 8))
			    (match_dup 4)
			    (match_dup 5)))]
{
...
(define_insn_and_split "*mov<FCMV1:mode><FCMV2:mode>cc_invert"
  [(set (match_operand:FCMV1 0 "vsx_register_operand" "=<FCMV1:Fm>")
	(if_then_else:FCMV1
...
(define_insn "*fpmask<mode>"
  [(set (match_operand:V2DI 0 "vsx_register_operand" "=wa")
	(if_then_else:V2DI
	 (match_operator:CCFP 1 "fpmask_comparison_operator"
		[(match_operand:FCMV1 2 "vsx_register_operand" "<Fm>")
		 (match_operand:FCMV1 3 "vsx_register_operand" "<Fm>")])
...
(define_insn "*xxsel<mode>"
  [(set (match_operand:FCMV1 0 "vsx_register_operand" "=<Fm>")
	(if_then_else:FCMV1 (ne (match_operand:V2DI 1 "vsx_register_operand" "wa")
				(match_operand:V2DI 2 "zero_constant" ""))
			   (match_operand:FCMV1 3 "vsx_register_operand" "<Fm>")
			   (match_operand:FCMV1 4 "vsx_register_operand" "<Fm>")))]
  "TARGET_P9_MINMAX"
  "xxsel %x0,%x4,%x3,%x1"
