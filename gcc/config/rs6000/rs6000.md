...
(define_code_attr uns_tf	[(fix		 "false")
				 (unsigned_fix	 "true")
				 (float		 "false")
				 (unsigned_float "true")])
...
(define_expand "float<QHI:mode><FP_ISA3:mode>2"
  [(parallel [(set (match_operand:FP_ISA3 0 "vsx_register_operand")
		   (float:FP_ISA3 (match_operand:QHI 1 "input_operand")))
	      (clobber (match_scratch:DI 2))
	      (clobber (match_scratch:DI 3))
...
(define_insn_and_split "*float<QHI:mode><FP_ISA3:mode>2_internal"
  [(set (match_operand:FP_ISA3 0 "vsx_register_operand"
			"=<FP_ISA3:Fv>,<FP_ISA3:Fv>,<FP_ISA3:Fv>")
	(float:FP_ISA3
	 (match_operand:QHI 1 "reg_or_indexed_operand" "wK,r,Z")))
   (clobber (match_scratch:DI 2 "=v,<FP_ISA3:Fv>,v"))
...
(define_expand "floatuns<QHI:mode><FP_ISA3:mode>2"
  [(parallel [(set (match_operand:FP_ISA3 0 "vsx_register_operand")
		   (unsigned_float:FP_ISA3 (match_operand:QHI 1 "input_operand")))
	      (clobber (match_scratch:DI 2))
	      (clobber (match_scratch:DI 3))])]
  "TARGET_P9_VECTOR && TARGET_DIRECT_MOVE && TARGET_POWERPC64
   && TARGET_VSX_SMALL_INTEGER"
...
(define_insn "*fix_trunc<SFDF:mode>si2_smallint"
  [(set (match_operand:SI 0 "vsx_register_operand" "=d,wa")
	(any_fix:SI (match_operand:SFDF 1 "vsx_register_operand" "d,wa")))]
  "TARGET_VSX_SMALL_INTEGER"
  "@
   fctiwz %0,%1
   xscvdpsxws %x0,%x1"
...
(define_insn "fix_trunc<SFDF:mode><QHI:mode>2"
  [(set (match_operand:QHI 0 "vsx_register_operand" "=d,wa")
	(fix:QHI (match_operand:SFDF 1 "vsx_register_operand" "d,wa")))]
  "TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT && TARGET_VSX_SMALL_INTEGER"
  "@
   fctiwz %0,%1
   xscvdpsxws %x0,%x1"
  [(set_attr "type" "fp")])
...
(define_insn "fix_trunc<IEEE128:mode><QHI:mode>2"
  [(set (match_operand:QHI 0 "altivec_register_operand" "=v")
	(fix:QHI (match_operand:IEEE128 1 "altivec_register_operand" "v")))]
  "TARGET_FLOAT128_HW"
  "xscvqpswz %0,%1"
  [(set_attr "type" "vecfloat")
   (set_attr "size" "128")])

;; These combined insns should prevent the register allocator from moving the
;; value to a GPR to do a store.
(define_insn_and_split "*fix_trunc<SFDF:mode><QHSI:mode>2_mem"
  [(set (match_operand:QHSI 0 "memory_operand" "=Z,Z")
	(fix:QHSI (match_operand:SFDF 1 "vsx_register_operand" "d,wa")))
   (clobber (match_scratch:QHSI 2 "=d,wa"))]
  "(<QHSI:MODE>mode == SImode || TARGET_P9_VECTOR) && TARGET_VSX_SMALL_INTEGER"
  "#"
  "&& reload_completed"
  [(set (match_dup 2)
...
(define_insn_and_split "*fix_trunc<IEEE128:mode><QHSI:mode>2_mem"
  [(set (match_operand:QHSI 0 "memory_operand" "=Z")
	(fix:QHSI (match_operand:IEEE128 1 "altivec_register_operand" "v")))
...
(define_insn "*fixuns_trunc<SFDF:mode>si2_smallint"
  [(set (match_operand:SI 0 "vsx_register_operand" "=d,wa")
	(unsigned_fix:SI (match_operand:SFDF 1 "vsx_register_operand" "d,wa")))]
  "TARGET_VSX_SMALL_INTEGER"
  "@
   fctiwuz %0,%1
   xscvdpuxws %x0,%x1"
...
(define_insn "fixuns_trunc<SFDF:mode><QHI:mode>2"
  [(set (match_operand:QHI 0 "vsx_register_operand" "=d,wa")
	(unsigned_fix:QHI
	 (match_operand:SFDF 1 "vsx_register_operand" "d,wa")))]
  "TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT && TARGET_VSX_SMALL_INTEGER"
  "@
   fctiwuz %0,%1
   xscvdpuxws %x0,%x1"
...
;; These combined insns should prevent the register allocator from moving the
;; value to a GPR to do a store.
(define_insn_and_split "*fixuns_trunc<SFDF:mode><QHSI:mode>2_mem"
  [(set (match_operand:QHSI 0 "memory_operand" "=Z,Z")
	(unsigned_fix:QHSI
	 (match_operand:SFDF 1 "vsx_register_operand" "d,wa")))
   (clobber (match_scratch:QHSI 2 "=d,wa"))]
   ...
   && TARGET_LONG_DOUBLE_128"
{
  ...
  if (FLOAT128_IEEE_P (<MODE>mode))
    {
      if (<MODE>mode == KFmode && TARGET_FLOAT128_HW)
	emit_insn (gen_float_kfsi2_hw (op0, op1));
      else if (<MODE>mode == TFmode && TARGET_FLOAT128_HW)
	emit_insn (gen_float_tfsi2_hw (op0, op1));
      else
   ...
   && (TARGET_FPRS || TARGET_E500_DOUBLE) && TARGET_LONG_DOUBLE_128"
{
  ...
  if (FLOAT128_IEEE_P (<MODE>mode))
    {
      if (<MODE>mode == KFmode && TARGET_FLOAT128_HW)
	emit_insn (gen_fix_kfsi2_hw (op0, op1));
      else if (<MODE>mode == TFmode && TARGET_FLOAT128_HW)
	emit_insn (gen_fix_tfsi2_hw (op0, op1));
      else
	rs6000_expand_float128_convert (op0, op1, false);
    }
...
{
  if (!TARGET_FLOAT128_HW || !FLOAT128_IEEE_P (<IEEE128:MODE>mode))
    {
...
(define_expand "float<uns>di<mode>2"
  [(set (match_operand:IEEE128 0 "gpc_reg_operand")
	(any_float:IEEE128 (match_operand:DI 1 "gpc_reg_operand")))]
  "TARGET_FLOAT128_TYPE"
{
  if (!TARGET_FLOAT128_HW || !FLOAT128_IEEE_P (<MODE>mode))
    {
      rs6000_expand_float128_convert (operands[0], operands[1], <uns_tf>);
      DONE;
    }
})

(define_expand "floatunssi<mode>2"
  [(parallel [(set (match_operand:IEEE128 0 "gpc_reg_operand")
...
(define_insn "fix<uns>_<mode>si2_hw"
...
(define_insn "fix<uns>_<mode>di2_hw"
  [(set (match_operand:DI 0 "altivec_register_operand" "=v")
	(any_fix:DI (match_operand:IEEE128 1 "altivec_register_operand" "v")))]
  "TARGET_FLOAT128_TYPE && TARGET_FLOAT128_HW && FLOAT128_IEEE_P (<MODE>mode)"
  "xscvqp<su>dz %0,%1"
  [(set_attr "type" "vecfloat")])

(define_insn "float<uns>_<mode>di2_hw"
  [(set (match_operand:IEEE128 0 "altivec_register_operand" "=v")
	(any_float:IEEE128 (match_operand:DI 1 "nonimmediate_operand" "v")))]
  "TARGET_FLOAT128_TYPE && TARGET_FLOAT128_HW && FLOAT128_IEEE_P (<MODE>mode)"
  "xscv<su>dqp %0,%1"
  [(set_attr "type" "vecfloat")])

(define_insn_and_split "float_<mode>si2_hw"
  [(set (match_operand:IEEE128 0 "gpc_reg_operand" "=v,v,v")
	(float:IEEE128
	 (match_operand:SI 1 "reg_or_indexed_operand" "v,Z,r")))
   (clobber (match_scratch:DI 2 "=v,v,v"))]
  "TARGET_FLOAT128_TYPE && TARGET_FLOAT128_HW && FLOAT128_IEEE_P (<MODE>mode)"
  "#"
  "&& reload_completed"
  [(set (match_dup 2)
