...
(define_insn "large_mov<mode>_load"
  ...
  "TARGET_LARGE_ADDRESS && TARGET_POWERPC64"
  "@
   addis %2,%M1\;<LADDR_FLOAD> %0,%m1(%2)
   addis %2,%M1\;<LADDR_VLOAD> %0,%m1(%2)
   addis %2,%M1\;<LADDR_GLOAD> %0,%m1(%2)"
  [(set_attr "length" "8")
...
(define_insn "large_mov<mode>_store"
  ...
  "TARGET_LARGE_ADDRESS && TARGET_POWERPC64"
  "@
   addis %2,%M0\;<LADDR_FSTORE> %1,%m0(%2)
   addis %2,%M0\;<LADDR_VSTORE> %1,%m0(%2)
   addis %2,%M0\;<LADDR_GSTORE> %1,%m0(%2)"
  [(set_attr "length" "8")
