  ...
  [(const_int 0)]
{
  ...
  /* XSCVDPSPN puts the 32-bit value in both the first and second words, so we
     do not need to do a shift to extract the value.  */
...
;		STFD       LFD        FMR        LXSD       STXSD      LXSDX
;		STXSDX     XXLOR      XXLXOR     LI         STD        LD
;		MR         MT%0       MF%1       NOP        MFTGPR     MFFGPR
;		MFVSRD     MVTVSRD
(define_insn "*mov<mode>_hardfloat64"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand"
		"=m,       d,         d,         <f64_p9>,  wY,        <f64_av>,
		 Z,        <f64_vsx>, <f64_vsx>, *r,        *Y,        *r,
		 *r,       *c*l,      *r,        *h,        !r,        wg,
		 *r,       !<f64_dm>")

	(match_operand:FMOVE64 1 "input_operand"
		"d,        m,         d,         wY,        <f64_p9>,  Z,
		<f64_av>,  <f64_vsx>, <zero_fp>, <zero_fp>, r,         Y,
		r,         r,         h,         0,         wg,        r,
		<f64_dm>,  r"))]
  "TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], <MODE>mode)
  ...
  "@
   ...
   mtvsrd %x0,%1"
  [(set_attr "type"
		"fpstore,  fpload,    fpsimple,  fpload,    fpstore,   fpload,
		 fpstore,  veclogical,veclogical,integer,   store,     load,
		 *,        mtjmpr,    mfjmpr,    *,         mftgpr,    mffgpr,
		 mftgpr,   mffgpr")
   (set_attr "size" "64")
   (set_attr "length" "4")])
...
(define_peephole2
  [(match_scratch:DI 0 "b")
   (set (match_operand:ALTIVEC_DFORM 1 "gpc_reg_operand")
