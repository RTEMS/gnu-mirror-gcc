...
(define_insn_and_split "*extendsfdf2_fpr"
  ...
  "@
   #
   * return rs6000_output_fmr (SFmode);
   lfs%U1%X1 %0,%1
   #
   * return rs6000_output_xscpsgndp ();
   lxsspx %x0,%y1
   lxssp %0,%1"
...
(define_insn "movsd_hardfloat"
  ...
  "@
   ...
   mtvsrwz %x0,%1
   mfvsrwz %0,%x1
   * return rs6000_output_fmr (SDmode);
   mr %0,%1
   mt%0 %1
   mf%1 %0
   nop"
...
(define_insn "*mov<mode>_hardfloat32"
  ...
  "@
   stfd%U0%X0 %1,%0
   lfd%U1%X1 %0,%1
   * return rs6000_output_fmr (<MODE>mode);
   lxsd %0,%1
   stxsd %1,%0
   lxsd%U1x %x0,%y1
   stxsd%U0x %x1,%y0
...
(define_insn_and_split "trunc<mode>df2_internal1"
  ...
  "@
   #
   * return rs6000_output_fmr (DFmode);"
...
(define_insn "*movdi_internal32"
  ...
  "@
   ...
   stfd%U0%X0 %1,%0
   lfd%U1%X1 %0,%1
   * return rs6000_output_fmr (DImode);
   #
   stxsd %1,%0
   stxsdx %x1,%y0
   lxsd %0,%1
