...
;; Large address splitters.

(define_split
  [(set (match_operand:DI 0 "gpc_reg_operand")
	(match_operand:DI 1 "large_mem_operand"))]
  "TARGET_LARGE_ADDRESS && can_create_pseudo_p ()"
  [(parallel [(set (match_dup 0)
		   (unspec:DI [(match_dup 1)] UNSPEC_LARGE_ADDRESS))
	      (clobber (match_scratch:DI 2))])]
  "")

(define_split
  [(set (match_operand:DI 0 "large_mem_operand")
	(match_operand:DI 1 "gpc_reg_operand"))]
  "TARGET_LARGE_ADDRESS && can_create_pseudo_p ()"
  [(parallel [(set (match_dup 0)
		   (unspec:DI [(match_dup 1)] UNSPEC_LARGE_ADDRESS))
