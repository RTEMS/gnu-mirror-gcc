...
;; SDmode
;;	LWZ          LFIWZX     LFIWZX     LXSIWZX    STFIWX     STFIWZ
;;	STXSIWX      STW        XXLXOR     LI         MTVSRWZ    MFVSRWZ
;;	FMR          XSCPSGNDP  MR         MT<x>      MF<x>      NOP
;;
;; SFmode
;;	LWZ          LFS        LXSSP      LXSSPX     STFS       STXSSP
;;	STXSSPX      STW        XXLXOR     LI         MTVSRWZ    MFVSRWZ
;;	FMR          XSCPSGNDP  MR         MT<x>      MF<x>      NOP

(define_insn "mov<mode>_hardfloat"
  [(set (match_operand:FMOVE32 0 "nonimmediate_operand"
	 "=!r,       <f32_lr>,  <f32_lr2>, <f32_av>,  <f32_sm>,  <f32_sm2>,
	  Z,         m,         <f32_vsx>, !r,        ?<f32_dm>, ?r,
	  f,         <f32_vsx>, !r,        *c*l,      !r,        *h")
	(match_operand:FMOVE32 1 "input_operand"
	 "m,         <f32_lm>,  <f32_lm2>, Z,         <f32_sr>,  <f32_sr2>,
	  <f32_av>,  ?r,        <zero_fp>, <zero_fp>, r,         <f32_dm>,
	  f,         <f32_vsx>, r,         r,         *h,        0"))]
  ...
  [(set_attr "type"
	"load,       fpload,    fpload,    fpload,    fpstore,   fpstore,
	 fpstore,    store,     veclogical,integer,   mffgpr,    mftgpr,
	 fpsimple,   fpsimple,  *,         mtjmpr,    mfjmpr,    *")])
