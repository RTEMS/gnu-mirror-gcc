...
(define_split
  ...
  "TARGET_LARGE_ADDRESS && !TARGET_TOC_BREAKOUT && TARGET_POWERPC64
   && can_create_pseudo_p ()"
  [(const_int 0)]
{
  if (!emit_large_address_store (operands[0], operands[1], <MODE>mode))
    gcc_unreachable ();
...
(define_split
  [(set (match_operand:LARGE_INT 0 "gpc_reg_operand")
	(match_operand:LARGE_INT 1 "large_mem_operand"))]
  "TARGET_LARGE_ADDRESS && !TARGET_TOC_BREAKOUT && TARGET_POWERPC64
   && can_create_pseudo_p ()"
  [(const_int 0)]
{
  if (!emit_large_address_load (operands[0], operands[1], <MODE>mode))
    gcc_unreachable ();
