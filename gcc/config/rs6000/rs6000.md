...
(define_insn "zero_extendqi<mode>2"
  [(set (match_operand:EXTQI 0 "gpc_nosf_reg_operand" "=r,r,^wJwK,^wK")
...
(define_insn "zero_extendhi<mode>2"
  [(set (match_operand:EXTHI 0 "gpc_nosf_reg_operand" "=r,r,^wJwK,^wK")
	(zero_extend:EXTHI
	 (match_operand:HI 1 "reg_or_mem_operand" "m,r,Z,wK")))]
  ""
  "@
   lhz%U1%X1 %0,%1
   rlwinm %0,%1,0,0xffff
...
(define_insn "zero_extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_nosf_reg_operand" "=r,r,wz,wu,wj,r,wJwK")
	(zero_extend:EXTSI
	 (match_operand:SI 1 "reg_or_mem_operand" "m,r,Z,Z,r,wIwH,wJwK")))]
  ""
  "@
   lwz%U1%X1 %0,%1
   rldicl %0,%1,0,32
...
(define_insn "extendqi<mode>2"
  [(set (match_operand:EXTQI 0 "gpc_nosf_reg_operand" "=r,?*wK")
	(sign_extend:EXTQI
	 (match_operand:QI 1 "gpc_nosf_reg_operand" "r,?*wK")))]
  ""
  "@
   extsb %0,%1
   vextsb2d %0,%1"
...
(define_expand "extendhi<mode>2"
  [(set (match_operand:EXTHI 0 "gpc_nosf_reg_operand")
	(sign_extend:EXTHI (match_operand:HI 1 "gpc_nosf_reg_operand")))]
  ""
  "")

(define_insn "*extendhi<mode>2"
  [(set (match_operand:EXTHI 0 "gpc_nosf_reg_operand" "=r,r,?*wK,?*wK")
...
(define_insn "extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_nosf_reg_operand" "=r,r,wl,wu,wj,wK")
...
(define_expand "and<mode>3"
  [(set (match_operand:SDI 0 "gpc_nosf_reg_operand" "")
	(and:SDI (match_operand:SDI 1 "gpc_nosf_reg_operand" "")
...
(define_insn "and<mode>3_imm"
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r")
	(and:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "%r")
...
(define_insn_and_split "*and<mode>3_imm_dot"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,??y")
	(compare:CC (and:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "%r,r")
...
(define_insn_and_split "*and<mode>3_imm_dot2"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,??y")
	(compare:CC (and:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "%r,r")
			     (match_operand:GPR 2 "logical_const_operand" "n,n"))
		    (const_int 0)))
   (set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r,r")
	(and:GPR (match_dup 1)
		 (match_dup 2)))
   (clobber (match_scratch:CC 4 "=X,x"))]
  "(<MODE>mode == Pmode || UINTVAL (operands[2]) <= 0x7fffffff)
...
(define_insn "*and<mode>3_imm_dot_shifted"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x")
	(compare:CC
	  (and:GPR
	    (lshiftrt:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "%r")
...
(define_expand "<code><mode>3"
  [(set (match_operand:SDI 0 "gpc_nosf_reg_operand" "")
	(iorxor:SDI (match_operand:SDI 1 "gpc_nosf_reg_operand" "")
		    (match_operand:SDI 2 "reg_or_cint_operand" "")))]
  ""
{
  if (<MODE>mode == DImode && !TARGET_POWERPC64)
...
(define_split
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "")
	(iorxor:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "")
...
(define_insn "*bool<mode>3_imm"
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r")
	(match_operator:GPR 3 "boolean_or_operator"
	 [(match_operand:GPR 1 "gpc_nosf_reg_operand" "%r")
	  (match_operand:GPR 2 "logical_const_operand" "n")]))]
  ""
  "%q3i%e2 %0,%1,%u2"
  [(set_attr "type" "logical")])
...
(define_insn "*bool<mode>3"
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r")
	(match_operator:GPR 3 "boolean_operator"
	 [(match_operand:GPR 1 "gpc_nosf_reg_operand" "r")
	  (match_operand:GPR 2 "gpc_nosf_reg_operand" "r")]))]
  ""
  "%q3 %0,%1,%2"
  [(set_attr "type" "logical")])
...
(define_insn_and_split "*bool<mode>3_dot"
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,?y")
	(compare:CC (match_operator:GPR 3 "boolean_operator"
	 [(match_operand:GPR 1 "gpc_nosf_reg_operand" "r,r")
	  (match_operand:GPR 2 "gpc_nosf_reg_operand" "r,r")])
	 (const_int 0)))
   (clobber (match_scratch:GPR 0 "=r,r"))]
  "<MODE>mode == Pmode && rs6000_gen_cell_microcode"
  "@
...
(define_insn "*boolc<mode>3"
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r")
	(match_operator:GPR 3 "boolean_operator"
	 [(not:GPR (match_operand:GPR 2 "gpc_nosf_reg_operand" "r"))
	  (match_operand:GPR 1 "gpc_nosf_reg_operand" "r")]))]
  ""
  "%q3 %0,%1,%2"
  [(set_attr "type" "logical")])
...
(define_insn_and_split "*boolc<mode>3_dot"
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,?y")
	(compare:CC (match_operator:GPR 3 "boolean_operator"
	 [(not:GPR (match_operand:GPR 2 "gpc_nosf_reg_operand" "r,r"))
	  (match_operand:GPR 1 "gpc_nosf_reg_operand" "r,r")])
	 (const_int 0)))
   (clobber (match_scratch:GPR 0 "=r,r"))]
  "<MODE>mode == Pmode && rs6000_gen_cell_microcode"
...
(define_insn "*boolcc<mode>3"
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r")
	(match_operator:GPR 3 "boolean_operator"
	 [(not:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "r"))
	  (not:GPR (match_operand:GPR 2 "gpc_nosf_reg_operand" "r"))]))]
  ""
  "%q3 %0,%1,%2"
  [(set_attr "type" "logical")])
...
(define_insn_and_split "*boolcc<mode>3_dot"
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,?y")
	(compare:CC (match_operator:GPR 3 "boolean_operator"
	 [(not:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "r,r"))
	  (not:GPR (match_operand:GPR 2 "gpc_nosf_reg_operand" "r,r"))])
	 (const_int 0)))
   (clobber (match_scratch:GPR 0 "=r,r"))]
  "<MODE>mode == Pmode && rs6000_gen_cell_microcode"
...
(define_insn "*eqv<mode>3"
  [(set (match_operand:GPR 0 "gpc_nosf_reg_operand" "=r")
	(not:GPR (xor:GPR (match_operand:GPR 1 "gpc_nosf_reg_operand" "r")
			  (match_operand:GPR 2 "gpc_nosf_reg_operand" "r"))))]
  ""
  "eqv %0,%1,%2"
  [(set_attr "type" "logical")])
...
(define_insn_and_split "movsi_from_sf"
  ...
  "@
   ...
   mtvsrwz %x0,%1
   #"
  "&& reload_completed && register_operand (operands[0], SImode)
   && vsx_register_operand (operands[1], SFmode)"
  [(const_int 0)]
{
  rtx op0 = operands[0];
  rtx op1 = operands[1];
...
(define_insn_and_split "movsf_from_si"
  ...
  "&& reload_completed
   && vsx_register_operand (operands[0], SFmode)
   && int_reg_operand (operands[1], SImode)"
  [(const_int 0)]
{
  rtx op0 = operands[0];
  rtx op1 = operands[1];
