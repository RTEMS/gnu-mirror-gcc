...
rs6000_option_override_internal (bool global_init_p)
{
  ...
  /* If we don't have prefixed addresssing or VSX, reset using XXSPLTIDP and
     XXSPLTIW instructions.  Since these are a temporary debug switches, don't
     worry about error messages.  */
  if (!TARGET_PREFIXED || !TARGET_POWER10 || !TARGET_VSX)
    TARGET_XXSPLTIW = TARGET_XXSPLTIDP = 0;
