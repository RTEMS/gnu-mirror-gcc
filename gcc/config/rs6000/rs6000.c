...
rs6000_option_override_internal (bool global_init_p)
{
  ...
  if (TARGET_POWER10 && (rs6000_isa_flags_explicit & OPTION_MASK_P10_FUSION_LOGADD) == 0)
    rs6000_isa_flags |= OPTION_MASK_P10_FUSION_LOGADD;

  if (TARGET_POWER10 && (rs6000_isa_flags_explicit & OPTION_MASK_P10_FUSION_ADDLOG) == 0)
