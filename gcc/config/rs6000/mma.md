...
(define_insn_and_split "*movpoi"
  [(set (match_operand:POI 0 "nonimmediate_operand" "=wa,m,wa,wa,m")
	(match_operand:POI 1 "input_operand"	    "m,wa,wa,m,wa"))]
  "TARGET_MMA
  ...
  [(const_int 0)]
{
  ...
  [(set_attr "type" "vecload,vecstore,veclogical,vecload,vecstore")
   (set_attr "length" "*,*,8,*,*")
   (set_attr "max_prefixed_insns" "*,*,*,2,2")
   (set_attr "isa" "mma,mma,*,*,*")])
...
(define_insn_and_split "truncpoidi2"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r")
	(truncate:DI
	 (match_operand:POI 1 "gpc_reg_operand" "wa")))]
  "TARGET_MMA"
  "#"
  "&& reload_completed"
  [(set (match_dup 0)
...
(define_insn_and_split "*movpxi"
  [(set (match_operand:PXI 0 "nonimmediate_operand" "=d,m,d,d,m,d")
	(match_operand:PXI 1 "input_operand"    "m,d,d,m,d,O"))]
  "TARGET_MMA
  ...
  [(const_int 0)]
{
  ...
  [(set_attr "type" "vecload,vecstore,veclogical,vecload,vecstore,mma")
   (set_attr "length" "8,8,16,16,16,*")
   (set_attr "max_prefixed_insns" "2,2,*,4,4,*")
   (set_attr "isa" "mma,mma,*,*,*,mma")])

(define_expand "mma_assemble_pair"
  [(match_operand:POI 0 "fpr_reg_operand")
...
;;	(unspec:PXI [(match_dup 0)]
;;		    UNSPEC_MMA_XXMFACC))
;;   (set (match_operand:PXI 1 "nonimmediate_operand")
;;	(match_dup 0))]
;;  "TARGET_MMA"
