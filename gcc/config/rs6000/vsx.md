...
;; Vector pair support.  V2KFmode is only defined for vector registers.
(define_expand "movv2kf"
  [(set (match_operand:V2KF 0 "nonimmediate_operand")
	(match_operand:V2KF 1 "input_operand"))]
  "TARGET_FUTURE"
{
  if (!gpc_reg_operand (operands[0], V2KFmode)
      && !gpc_reg_operand (operands[1], V2KFmode))
    operands[1] = force_reg (V2KFmode, operands[1]);
})

(define_insn_and_split "*movv2kf"
  [(set (match_operand:V2KF 0 "nonimmediate_operand" "=wa,m,wa")
	(match_operand:V2KF 1 "input_operand" "m,wa,wa"))]
...
(define_insn_and_split "*movv2kf_no_vector_pair"
