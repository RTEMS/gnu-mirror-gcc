...
.. include:: tm.rst.in
  :start-after: [TARGET_VECTORIZE_INIT_COST]
  :end-before: [TARGET_VECTORIZE_INIT_COST]


.. include:: tm.rst.in
  :start-after: [TARGET_VECTORIZE_ADD_STMT_COST]
  :end-before: [TARGET_VECTORIZE_ADD_STMT_COST]


.. include:: tm.rst.in
  :start-after: [TARGET_VECTORIZE_FINISH_COST]
  :end-before: [TARGET_VECTORIZE_FINISH_COST]


.. include:: tm.rst.in
  :start-after: [TARGET_VECTORIZE_DESTROY_COST_DATA]
  :end-before: [TARGET_VECTORIZE_DESTROY_COST_DATA]
